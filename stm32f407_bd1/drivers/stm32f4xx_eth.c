...
#define ETH_MIMODE    0                 /* 0:MII 1:RMII */ 

static const ETH_PinTypeDef eth_pins[] =
{
  {ETH_MDI_MDC_PORT,      ETH_MDI_MDC_PIN     },
  {ETH_MDI_MDIO_PORT,     ETH_MDI_MDIO_PIN    },
#if (ETH_MIMODE == 1)
  {ETH_RMII_TXD0_PORT,    ETH_RMII_TXD0_PIN   },
  {ETH_RMII_TXD1_PORT,    ETH_RMII_TXD1_PIN   },
  {ETH_RMII_TX_EN_PORT,   ETH_RMII_TX_EN_PIN  },
  {ETH_RMII_RXD0_PORT,    ETH_RMII_RXD0_PIN   },
  {ETH_RMII_RXD1_PORT,    ETH_RMII_RXD1_PIN   },
  {ETH_RMII_REF_CLK_PORT, ETH_RMII_REF_CLK_PIN},
  {ETH_RMII_CRS_DV_PORT,  ETH_RMII_CRS_DV_PIN }
#else
  {ETH_MII_TX_CLK_PORT,   ETH_MII_TX_CLK_PIN  },
  {ETH_MII_TXD0_PORT,     ETH_MII_TXD0_PIN    },
  {ETH_MII_TXD1_PORT,     ETH_MII_TXD1_PIN    },
  {ETH_MII_TXD2_PORT,     ETH_MII_TXD2_PIN    },
  {ETH_MII_TXD3_PORT,     ETH_MII_TXD3_PIN    },
  {ETH_MII_TX_EN_PORT,    ETH_MII_TX_EN_PIN   },
  {ETH_MII_RX_CLK_PORT,   ETH_MII_RX_CLK_PIN  },
  {ETH_MII_RXD0_PORT,     ETH_MII_RXD0_PIN    },
  {ETH_MII_RXD1_PORT,     ETH_MII_RXD1_PIN    },
  {ETH_MII_RXD2_PORT,     ETH_MII_RXD2_PIN    },
  {ETH_MII_RXD3_PORT,     ETH_MII_RXD3_PIN    },
  {ETH_MII_RX_DV_PORT,    ETH_MII_RX_DV_PIN   },
  {ETH_MII_RX_ER_PORT,    ETH_MII_RX_ER_PIN   },
  {ETH_MII_CRS_PORT,      ETH_MII_CRS_PIN     },
  {ETH_MII_COL_PORT,      ETH_MII_COL_PIN     }
#endif
};
...
#if 1
	for (pin = eth_pins; pin != &eth_pins[sizeof(eth_pins)/sizeof(ETH_PinTypeDef)]; pin ++)
	{
	    GPIO_PinAFConfig(pin->port, pin->num, GPIO_AF_ETH);
		GPIO_InitStructure.GPIO_Pin = 1 << pin->num;
