...
#define ETH_MII_TX_CLK_PIN          3
#define ETH_MII_TXD0_PORT           GPIOB
#define ETH_MII_TXD0_PIN            12
#define ETH_MII_TXD1_PORT           GPIOG
#define ETH_MII_TXD1_PIN            14
#define ETH_MII_TXD2_PORT           GPIOC
#define ETH_MII_TXD2_PIN            2
#define ETH_MII_TXD3_PORT           GPIOB
#define ETH_MII_TXD3_PIN            8
#define ETH_MII_TX_EN_PORT          GPIOB
#define ETH_MII_TX_EN_PIN           11
#define ETH_MII_RX_CLK_PORT         GPIOA
#define ETH_MII_RX_CLK_PIN          1
#define ETH_MII_RXD0_PORT           GPIOC
#define ETH_MII_RXD0_PIN            4
#define ETH_MII_RXD1_PORT           GPIOC
#define ETH_MII_RXD1_PIN            5
#define ETH_MII_RXD2_PORT           GPIOB
#define ETH_MII_RXD2_PIN            0
#define ETH_MII_RXD3_PORT           GPIOB
#define ETH_MII_RXD3_PIN            1
#define ETH_MII_RX_DV_PORT          GPIOA
#define ETH_MII_RX_DV_PIN           7
#define ETH_MII_RX_ER_PORT          GPIOB
#define ETH_MII_RX_ER_PIN           10
#define ETH_MII_CRS_PORT            GPIOA
#define ETH_MII_CRS_PIN             0
#define ETH_MII_COL_PORT            GPIOA
#define ETH_MII_COL_PIN             3
/* RMII GPIO */
#if (RMII_TX_GPIO_GROUP == 1)
#define ETH_RMII_TXD0_PORT          GPIOB
#define ETH_RMII_TXD0_PIN           12
#define ETH_RMII_TXD1_PORT          GPIOB
#define ETH_RMII_TXD1_PIN           13
#define ETH_RMII_TX_EN_PORT         GPIOB
#define ETH_RMII_TX_EN_PIN          11
#else
#define ETH_RMII_TXD0_PORT          GPIOG
#define ETH_RMII_TXD0_PIN           13
#define ETH_RMII_TXD1_PORT          GPIOG
#define ETH_RMII_TXD1_PIN           14
#define ETH_RMII_TX_EN_PORT         GPIOG
#define ETH_RMII_TX_EN_PIN          11
#endif
#define ETH_RMII_RXD0_PORT          GPIOC
#define ETH_RMII_RXD0_PIN           4
#define ETH_RMII_RXD1_PORT          GPIOC
#define ETH_RMII_RXD1_PIN           5
#define ETH_RMII_REF_CLK_PORT       GPIOA
#define ETH_RMII_REF_CLK_PIN        1
#define ETH_RMII_CRS_DV_PORT        GPIOA
#define ETH_RMII_CRS_DV_PIN         7

#define ETH_MDI_MDC_PORT            GPIOC
#define ETH_MDI_MDC_PIN             1
#define ETH_MDI_MDIO_PORT           GPIOA
#define ETH_MDI_MDIO_PIN            2

#if (REF_CLOCK_PORT_ID == 0)
#define ETH_REF_CLOCK_PORT          GPIOA
#define ETH_REF_CLOCK_PIN           8
#else
#define ETH_REF_CLOCK_PORT          GPIOC
#define ETH_REF_CLOCK_PIN           9
#endif
